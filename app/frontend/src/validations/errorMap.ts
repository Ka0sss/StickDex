// Espejo de app/backend/src/validations/errorMap.ts: mantén los mensajes sincronizados.
import { z } from 'zod'
...
/** Traduce los mensajes de Zod al español. Importar este módulo registra el mapa. */
